  ...
  return (
    <>
      <CardHeader>
        ...
        <CardDescription>Manage API tokens to authenticate your applications</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="flex items-center space-x-4">
          <Input placeholder="API Token Name" value={newKeyName} onChange={(e) => setNewKeyName(e.target.value)} />
      ...
      <CardFooter className="flex justify-between">
        <div className="text-sm text-muted-foreground">
          ...
          API tokens provide full access to your account. Keep them secure!
        </div>
