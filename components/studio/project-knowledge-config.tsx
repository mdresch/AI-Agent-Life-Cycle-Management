...
export function ProjectKnowledgeConfig({ data, updateData }) {
  ...
  }, [sources, retrievalStrategy, chunkSize, topK, autoCitation, knowledgeFallback, updateData])
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="top-k" type="number" value={topK} onChange={(e) => setTopK(Number.parseInt(e.target.value))} />
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Switch id="auto-citation" checked={autoCitation} onCheckedChange={setAutoCitation} />
            </div>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Switch id="knowledge-fallback" checked={knowledgeFallback} onCheckedChange={setKnowledgeFallback} />
            </div>
            <p className="text-sm text-muted-foreground">
