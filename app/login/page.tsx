...
// Outer page component – keeps the static shell outside the Suspense boundary
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-8">
        {/* Logo – static, no client hooks needed */}
        ...
        {/*
          useSearchParams() is only called inside <LoginForm>.
          Wrapping it in <Suspense> satisfies the Next.js requirement that
          useSearchParams must not block static prerendering of the page.
        */}
        <Suspense
          fallback={
            <div className="rounded-xl border bg-card p-8 shadow-sm flex items-center justify-center min-h-[320px]">
